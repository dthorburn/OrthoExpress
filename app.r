...
#  params.directory <- "C:/Users/Miles/Documents/Imperial/Projects/01_Neg_Dom_Allele/06_RNA_Seq"
#  params.directory <- "C:/Users/Miles/Documents/Imperial/Projects/05_OrthoExpress/02_Orthology_Data/04_App_Data"
...
#save.image(file = "All_Expression_Dat_271021.RData")
#save.image(file = "All_Orthology_Dat_261021.RData")

## loading in data
#load(file = "All_Expression_Dat_201021.RData")
load(file = "All_Expression_Dat_271021.RData")
...
#    paste0("Query: ", paste(gene_id(), input$annGroup, sep = "; "))
#  })
#  output$txt <- renderText({
#    data_names <- input$checkGroup
#    paste0("Expression Datasets: ", paste(data_names, collapse = ", "))
#  })
#  output$Exp_Errs <- renderText({
#    paste0("Expression Warnings: ", paste(errors))
#  })
#  output$Orth_Errs <- renderText({
#    #paste0("Orthology Warnings: ", paste(Orth_errors()))
#  })
}
shinyApp(ui, server)  
